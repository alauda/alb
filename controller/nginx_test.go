	...
	cases := []TestCase{
		{
			...
			Assert: func(albPolicy NgxPolicy, ngxCfg string) {
				...
				AssertBackendsEq(t, albPolicy.GetBackendGroup("rule-1").Backends, []*Backend{{"192.168.20.3", 8002, 50}, {"192.168.20.4", 8002, 50}})
				AssertBackendsEq(t, albPolicy.GetBackendGroup("rule-2").Backends, []*Backend{{"192.168.20.3", 8004, 25}, {"192.168.20.4", 8004, 25}, {"192.168.20.3", 8002, 25}, {"192.168.20.4", 8002, 25}})
				AssertBackendsEq(t, albPolicy.GetBackendGroup("alb-1-8000-http").Backends, []*Backend{{"192.168.10.4", 8001, 50}, {"192.168.10.5", 8001, 50}})
			},
		},
		{
			Name: "tcp",
			...
			Assert: func(albPolicy NgxPolicy, ngxCfg string) {
				...
				AssertBackendsEq(t, albPolicy.GetBackendGroup("alb-1-8000-tcp").Backends, []*Backend{{"192.168.10.4", 8001, 50}, {"192.168.10.5", 8001, 50}})
			},
		},
		{
			Name: "udp",
			...
			Assert: func(albPolicy NgxPolicy, ngxCfg string) {
				...
				AssertBackendsEq(t, albPolicy.GetBackendGroup("alb-1-8000-udp").Backends, []*Backend{{"192.168.10.4", 8001, 50}, {"192.168.10.5", 8001, 50}})
			},
		},
		{
