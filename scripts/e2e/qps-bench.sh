...
main() {
	# compare "build-harbor.alauda.cn/acp/alb2:v3.3.12" "build-harbor.alauda.cn/acp/alb2:v3.5-50-gad3b41a"
	# compare "build-harbor.alauda.cn/acp/alb2:v3.3.12" "build-harbor.alauda.cn/acp/alb2:v3.4.0"
	# compare "build-harbor.alauda.cn/acp/alb2:v3.3.12" "offical-resty-ubuntu-alb:latest"
	# dotest "offical-resty-ubuntu-alb:v1" "k-16-alb-test"
	# dotest "test-alb:3.5-origin-without-luajit-patch" "k-16-alb-test"
	# dotest "test-alb:v3.5-use-luajit2" "k-16-alb-test"
}
