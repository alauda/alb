-- https://github.com/knyar/nginx-lua-prometheus/blob/1c26a729146e196c42d99d2783e65edbd28c82c3/prometheus.lua
--- @module Prometheus
--
...
local resty_counter_lib = require("prometheus.prometheus_resty_counter")
