...
type ALB2Lister interface {
	...
	List(selector labels.Selector) (ret []*v2beta1.ALB2, err error)
...
// List lists all ALB2s in the indexer.
func (s *aLB2Lister) List(selector labels.Selector) (ret []*v2beta1.ALB2, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v2beta1.ALB2))
	})
	return ret, err
}
...
type ALB2NamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v2beta1.ALB2, error)
...
// List lists all ALB2s in the indexer for a given namespace.
func (s aLB2NamespaceLister) List(selector labels.Selector) (ret []*v2beta1.ALB2, err error) {
...
// Get retrieves the ALB2 from the indexer for a given namespace and name.
func (s aLB2NamespaceLister) Get(name string) (*v2beta1.ALB2, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v2beta1.Resource("alb2"), name)
	}
	return obj.(*v2beta1.ALB2), nil
}
