	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1().Frontends(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1().Frontends(namespace).Watch(context.TODO(), options)
			},
		},
		&alaudav1.Frontend{},
		resyncPeriod,
...
func (f *frontendInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&alaudav1.Frontend{}, f.defaultInformer)
}

func (f *frontendInformer) Lister() v1.FrontendLister {
	return v1.NewFrontendLister(f.Informer().GetIndexer())
}
