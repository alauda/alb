...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=crd.alauda.io, Version=v1
	case v1.SchemeGroupVersion.WithResource("alaudaloadbalancer2"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Crd().V1().ALB2s().Informer()}, nil
	case v1.SchemeGroupVersion.WithResource("frontends"):
	...
	case v1.SchemeGroupVersion.WithResource("rules"):
		...
		// Group=crd.alauda.io, Version=v2beta1
	case v2beta1.SchemeGroupVersion.WithResource("alaudaloadbalancer2"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Crd().V2beta1().ALB2s().Informer()}, nil
