...
// CrdV1Client is used to interact with features provided by the crd.alauda.io group.
type CrdV1Client struct {
	restClient rest.Interface
}

func (c *CrdV1Client) ALB2s(namespace string) ALB2Interface {
	return newALB2s(c, namespace)
}

func (c *CrdV1Client) Frontends(namespace string) FrontendInterface {
