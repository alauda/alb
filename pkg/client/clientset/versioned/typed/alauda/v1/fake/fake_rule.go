...
func (c *FakeRules) Get(name string, options v1.GetOptions) (result *alaudav1.Rule, err error) {
	obj, err := c.Fake.
...
func (c *FakeRules) List(opts v1.ListOptions) (result *alaudav1.RuleList, err error) {
	obj, err := c.Fake.
...
func (c *FakeRules) Create(rule *alaudav1.Rule) (result *alaudav1.Rule, err error) {
	obj, err := c.Fake.
...
func (c *FakeRules) Update(rule *alaudav1.Rule) (result *alaudav1.Rule, err error) {
	obj, err := c.Fake.
