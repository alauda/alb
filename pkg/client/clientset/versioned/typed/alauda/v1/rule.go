...
type RuleInterface interface {
	...
	Get(name string, options metav1.GetOptions) (*v1.Rule, error)
	List(opts metav1.ListOptions) (*v1.RuleList, error)
...
func (c *rules) Get(name string, options metav1.GetOptions) (result *v1.Rule, err error) {
	result = &v1.Rule{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("rules").
...
func (c *rules) Delete(name string, options *metav1.DeleteOptions) error {
