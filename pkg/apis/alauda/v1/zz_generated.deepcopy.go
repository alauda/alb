...
import (
	keepalivetypes "alauda.io/alb2/pkg/controller/ext/keepalive/types"
	types "alauda.io/alb2/pkg/controller/ext/redirect/types"
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FTConfig) DeepCopyInto(out *FTConfig) {
	*out = *in
	in.SharedCr.DeepCopyInto(&out.SharedCr)
	if in.Redirect != nil {
		in, out := &in.Redirect, &out.Redirect
		*out = new(types.RedirectCr)
		(*in).DeepCopyInto(*out)
	}
	if in.KeepAlive != nil {
		in, out := &in.KeepAlive, &out.KeepAlive
		*out = new(keepalivetypes.KeepAliveCr)
		(*in).DeepCopyInto(*out)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FTConfig.
func (in *FTConfig) DeepCopy() *FTConfig {
	if in == nil {
		return nil
	}
	out := new(FTConfig)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RuleConfigInCr) DeepCopyInto(out *RuleConfigInCr) {
	*out = *in
	in.SharedCr.DeepCopyInto(&out.SharedCr)
	if in.Redirect != nil {
		in, out := &in.Redirect, &out.Redirect
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RuleConfigInCr.
func (in *RuleConfigInCr) DeepCopy() *RuleConfigInCr {
	if in == nil {
		return nil
	}
	out := new(RuleConfigInCr)
	in.DeepCopyInto(out)
	return out
}
