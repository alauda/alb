...
func (in *ExternalGateway) DeepCopyInto(out *ExternalGateway) {
	*out = *in
	...
	if in.GatewayModeCfg != nil {
		in, out := &in.GatewayModeCfg, &out.GatewayModeCfg
		*out = new(ExternalGatewayModeCfg)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalGatewayModeCfg) DeepCopyInto(out *ExternalGatewayModeCfg) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalGatewayModeCfg.
func (in *ExternalGatewayModeCfg) DeepCopy() *ExternalGatewayModeCfg {
	if in == nil {
		return nil
	}
	out := new(ExternalGatewayModeCfg)
